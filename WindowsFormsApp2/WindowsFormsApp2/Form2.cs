...
namespace WindowsFormsApp2
{
    public partial class Form2 : Form
    {
        ...
        private void GAMERUN()
        {
            ...
            for (int i = 0; i <= 3; i++)
            {
                SEQUENCEDISPLAY[i].BackColor = Color.Gray;
            }
        ...
        private void INPUTMAINCODE_Click(object sender, EventArgs e)
        {
            for (int i = 0; i <= 3; i++)
            {
                MAINCODE[i] = SEQUENCEDISPLAY[i].BackColor;
            }
            for (int i = 0; i <= 3; i++)
            {
                SEQUENCEDISPLAY[i].BackColor = Color.Gray;
